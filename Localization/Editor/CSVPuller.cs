...
public class CSVPuller : EditorWindow {
    ...
    private static string PREF_KEY = "LOCALIZATION_CSV_LOCAL_PATH_";
    private static string PREF_SOURCE_KEY = "LOCALIZATION_CSV_SOURCE_PATH_";
    ...
    static CSVPuller()
    {
        // Make pref keys unique per project.
        PREF_KEY += Application.productName;
        PREF_SOURCE_KEY += Application.productName;
